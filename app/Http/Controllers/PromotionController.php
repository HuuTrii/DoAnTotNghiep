    ...
    public function getpromotiondata()
        {
            ...
            return Datatables::of(Promotion::query())
               ->addColumn('action', function ($Promotion) {
                  return "<a href='" . route('promotionDestroy', $Promotion->id_promotion ) . "'>  <span class='badge badge-danger' style='padding: 1% 5%; margin-right:20px'><i class='fa fa-trash'></i></span></a>

                 <a href='#' class='editbtn'> <span data-toggle='modal' data-target='#editmodal' class='badge badge-success' style='padding: 1% 5%;'><i class='fa fa-edit'></i></span></a>";
                })
            ->make(true);
        }
    public function getsale()
        {
            $Promotionsale = Promotion::select(['sale']);
            return Datatables::of($Promotionsale)->make(true);
