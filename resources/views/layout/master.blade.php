...
<head>
    ...
    <title>CloudStock | Trang web quản lý kho hàng</title>
...
<body class="hold-transition skin-black sidebar-mini">
    ...
    @stack('scripts_unit')
    @stack('scripts_promotion')
    @stack('scripts_vendor')
    @stack('scripts_product_types')
    ...
    <script src="{{asset('js/main/pages/widget-charts2.js')}}"></script>
