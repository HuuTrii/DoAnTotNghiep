        ...
        <div class="text-center">
            ...
            <p class="gap-items-2 mb-0">
                <a class="btn btn-social-icon btn-outline btn-circle btn-facebook" href="#"><i
                        style="margin-top: 22%;" class="fab fa-facebook-square"></i></a>
                <a class="btn btn-social-icon btn-outline btn-circle btn-twitter" href="#"><i
                        style="margin-top: 22%;" class="fab fa-twitter-square"></i></a>
                <a class="btn btn-social-icon btn-outline btn-circle btn-google" href="#"><i
                        style="margin-top: 22%;" class="fab fa-google-plus-square"></i></a>
            </p>
        </div>
    </div>
</div>
<div class="col-lg-7 col-md-6 col-12">
    <div class="p-20 content-bottom">
                        ...
                        <div class="controls">
                            <div class="input-group mb-3">
                                <input type="text" name="lastname" class="form-control" required=""
                                       ...
                                       minlength="2" maxlength="6" placeholder="Họ" aria-invalid="false">
                        ...
                        <div class="controls">
                            <div class="input-group mb-3">
                                <input type="text" name="name" class="form-control" required=""
                                       data-validation-required-message="This field is required"
                                       minlength="2" maxlength="100" placeholder="Tên" aria-invalid="false">
                                <div class="input-group-prepend">
                                    <span class="input-group-text bg-info border-info"><i
                                            class="ti-user"></i></span>
                                </div>
                ...
                <div class="controls">
                    <div class="input-group mb-3">
                        <input type="password" name="password_confirmation"
                               ...
                               aria-invalid="true" placeholder="Xác nhận mật khẩu">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-info border-info"><i
                        ...
                        <div class="controls">
                            ...
                            <div class="help-block"></div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="input-group mb-3">
                                                                <input type="number" name="phone_number" class="form-control" placeholder="Số điện thoại">
                                                                <div class="input-group-prepend">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="checkbox">
                        ...
                        <label for="basic_checkbox_1">Tôi đồng ý với<a href="#"
                                                                       style="color: rgb(3, 169, 243);"><b>
                                    các điều khoản</b></a></label>
                    </div>
                </div>
                <!-- /.col -->
        ...
        <div class="text-center">
            <p class="mb-0 mt-10">Tôi đã có tài khoản <a class="text-info ml-5"
