...
class CatalogController extends Controller
{
    ...
    public function getprotypedata()
    {
        $Catalog = Catalog::all();

        return Datatables::of(Catalog::query())
            ->addColumn('action', function ($Catalog) {
                return "<a href='" . route('catalogDestroy', $Catalog->id_cata ) . "'>  <span class='badge badge-danger' style='padding: 1% 5%; margin-right:20px'><i class='fa fa-trash'></i></span></a>
